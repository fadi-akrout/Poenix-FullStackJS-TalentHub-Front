...
const useAuth = () => {
    ...
    if (token) {
        ...
        return { username,email, roles, status, isStudent, isAdmin,isAlumni,isRecruter, isTeacher}
    }

    return { username: '', email: '', roles: [], isStudent, isAdmin,isAlumni,isRecruter,isTeacher, status }
}
