        ...
        <>
         <main className='main-container'>
            <section >
                ...
                <h1 className="text-center mb-4 black-text">Events List</h1>
                                    {evenements.map(evenement => (
                        <EvenementAdmin evenement={evenement} setEvenements={setEvenements} key={evenement._id} />
                    ))}
                    <div className="text-center mt-4">
                        <Link to="/admin/addEvent" className="btn btn-danger">Ajouter un événement</Link>
                    </div>
                </div>
...
function EvenementAdmin({ evenement, setEvenements }) {
    ...
    return (
        ...
        <div key={evenement._id} className="cardadmin mb-3">
            {enEdition ? (
